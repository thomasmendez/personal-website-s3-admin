          ...
          {websites.map((item, index) => (
            <li key={index}>
                <a
                  target="_blank"
                  href={item.link}
                  className="flex items-center justify-center gap-2 hover:opacity-70"
                >
                  {item.text}
                  <span className="[&>svg]:h-5 [&>svg]:w-5">{websiteIcons[item.icon]}</span>
                </a>
            </li>
          ))}
        </ul>
