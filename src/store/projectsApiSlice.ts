...
import { apiPostProject, apiGetProjects, apiPutProject, apiDeleteProject } from "../services/personalWebsiteApi"

export const postProjects = createAsyncThunk(
    'post/projects',
    async (postProjects: ProjectComponent, thunkApi) => {
        try {
            const response = await apiPostProject(postProjects)
...
export const putProjects = createAsyncThunk(
    ...
    async (updateProjects: ProjectComponent, thunkApi) => {
        try {
            const response = await apiPutProject(updateProjects)
...
export const deleteProjects = createAsyncThunk(
    ...
    async (deleteProjects: ProjectComponent, thunkApi) => {
        try {
            const response = await apiDeleteProject(deleteProjects)
