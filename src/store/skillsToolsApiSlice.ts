...
import { apiRequestPostSkillsTools, apiRequestGetSkillsTools, apiRequestPutSkillsTools, apiRequestDeleteSkillsTools } from "../services/personalWebsiteApi"

export const postSkillsTools = createAsyncThunk(
    'post/skillsTools',
    async (postSkillsTools: SkillsTools, thunkApi) => {
        try {
            const response = await apiRequestPostSkillsTools(postSkillsTools)
...
export const getSkillsTools = createAsyncThunk(
    ...
    async (_, thunkApi) => {
        try {
            const response = await apiRequestGetSkillsTools()
...
export const putSkillsTools = createAsyncThunk(
    ...
    async (updateSkillsTools: SkillsTools, thunkApi) => {
        try {
            const response = await apiRequestPutSkillsTools(updateSkillsTools)
...
export const deleteSkillsTools = createAsyncThunk(
    ...
    async (deleteSkillsTools: SkillsTools, thunkApi) => {
        try {
            const response = await apiRequestDeleteSkillsTools(deleteSkillsTools)
