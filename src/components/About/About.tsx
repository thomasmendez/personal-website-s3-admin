    ...
    <section className="grid grid-cols-12 sm:gap-12 md:gap-22 bg-neutral-200 dark:bg-neutral-900">
      ...
      <section className="p-4 col-span-2 space-y-2">
        ...
        <div className="flex">
          ...
          >
            <svg className="h-6 w-6 text-gray-900 dark:text-gray-300"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <rect x="3" y="5" width="18" height="14" rx="2" />  <polyline points="3 7 12 13 21 7" /></svg>
          </button>
