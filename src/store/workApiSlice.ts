...
import { apiPostWork, apiGetWork, apiPutWork, apiDeleteWork } from "../services/personalWebsiteApi"

export const postWork = createAsyncThunk(
    'post/work',
    async (postWork: Work, thunkApi) => {
        try {
            const response = await apiPostWork(postWork)
...
export const getWork = createAsyncThunk(
    ...
    async (_, thunkApi) => {
        try {
            const response = await apiGetWork()
...
export const putWork = createAsyncThunk(
    ...
    async (updateWork: Work, thunkApi) => {
        try {
            const response = await apiPutWork(updateWork)
...
export const deleteWork = createAsyncThunk(
    ...
    async (deleteWork: Work, thunkApi) => {
        try {
            const response = await apiDeleteWork(deleteWork)
